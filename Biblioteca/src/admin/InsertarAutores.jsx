...
const InsertarAutores = () => {
  ...
  useEffect(() => {
    ...
    if (!['admin', 'bibliotecario'].includes(user.rol)) {
      navigate('/dashboard');
      return;
    }
  }, [user, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Token being sent:', user.token); // Para debugging
      console.log('Form data:', formData); // Para debugging

      const response = await apiPost('authors', formData, user.token);
    ...
    <div className="container mt-4">
      <div className="card shadow">
        <div className="card-header bg-info text-white">
          <h2 className="mb-0"><i className="fas fa-user-plus me-2"></i>Agregar Nuevo Autor</h2>
        </div>
            ...
            <div className="d-grid gap-2 d-md-flex justify-content-md-end">
              ...
              >
                {loading ? (
                  ...
                  <>
                    <i className="fas fa-save me-2"></i>Guardar Autor
                  </>
                )}
              </button>
...
export default InsertarAutores;